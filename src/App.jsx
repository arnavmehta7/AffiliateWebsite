          ...
          <nav className="navbar navbar-expand-lg navbar-light">
            ...
            <div className="collapse navbar-collapse" id="mainmenu">
              <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#pricing">Products</a>
                </li>
        ...
        <div className="col-lg-6 d-flex align-self-center">
          <div className="left-content">
            <div className="content">
              ...
              <div className="links">
                <a href="#" className="mybtn1"><span>Buy Now</span> </a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="left-feature">
            <div className="feature-box feature-box1">
              <div className="feature-circle">
                <div className="feature-circle-inner"><i className="fas fa-plus"></i></div>
              </div>
              <div className="details">
                ...
                <p className="text">New had happen unable uneasy. Drawings pronounce can be followed improved out.</p>
              </div>
            ...
            <div className="feature-box feature-box2">
              ...
              <div className="details">
                <h4>
                  <a href="#" className="title">Alarm Alert</a>
                </h4>
                <p className="text">New had happen unable uneasy. Drawings pronounce can be followed improved out.</p>
              </div>
              <div className="icon-area">
            ...
            <div className="feature-box feature-box3">
              ...
              <div className="details">
                <h4>
                  <a href="#" className="title">Distance Counter</a>
                </h4>
                <p className="text">New had happen unable uneasy. Drawings pronounce can be followed improved out.</p>
              </div>
              <div className="icon-area">
        ...
        <div className="col-lg-4">
          <div className="right-feature">
            <div className="feature-box feature-box4">
              ...
              <div className="details">
                <h4>
                  <a href="#" className="title">Bluetooth </a>
                </h4>
                <p className="text">New had happen unable uneasy. Drawings pronounce can be followed improved out.</p>
              </div>
            </div>
            <div className="feature-box feature-box5">
              ...
              <div className="details">
                <h4>
                  <a href="#" className="title">Weather Update</a>
                </h4>
                <p className="text">New had happen unable uneasy. Drawings pronounce can be followed improved out.</p>
              </div>
            </div>
            <div className="feature-box feature-box6">
              ...
              <div className="details">
                <h4>
                  <a href="#" className="title">Video Call</a>
                </h4>
                <p className="text">New had happen unable uneasy. Drawings pronounce can be followed improved out.</p>
              </div>
            </div>
